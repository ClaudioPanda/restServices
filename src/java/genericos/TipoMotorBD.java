...
public enum TipoMotorBD {
    POSTGRESQL ("postgresql", "org.postgresql.Driver","laboratorio_sc","postgres","1","5432","localhost"),
    MYSQL ("mysql","com.mysql.jdbc.Driver","laboratorio","root","root","3306","localhost");
